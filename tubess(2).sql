...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jan 2020 pada 06.16
...
(20, 16, 'Adidas 4dOnix ', 12700000, 120, 'image001.jpg', '<p>Sesuai Gambar SIZE : 39-43&nbsp;</p><p>KUALITAS : Import Vietnam&nbsp;</p><p>STOK : Ready (limited/terbatas)&nbsp;</p><p>PESAN SEKARANG JUGA (Tulis dalam&nbsp;alamat: warna, dan ukuran)&nbsp;</p><p>Contoh : Order warna hitam foto no 2, size 40</p>', 'pria', 5, 0),
(21, 16, 'Adidas Ultraboost Woodwood 1.0 ', 11500000, 120, 'image003.jpg', '<p>Sepatu 100% Real Pict ( Beda Boleh Dikembalikan ) Size : 39-44&nbsp;</p><p>Kualitas : IMPORT Sudah lengkap dengan Box.&nbsp;</p><p>Untuk order jangan lupa sertakan size dan warna pada kolom alamat. Contoh : size 40 warna hitam</p>', 'pria', 11, 0),
(22, 16, 'Adidas Originals Men X_PLR Shoes Sepatu Olahraga Pria [F34037]', 1200000, 120, 'image005.jpg', '<p>Fitur Produk</p><ul><li>Sepatu olahraga pria</li><li>Didesain trendy sporty</li><li>Dirancang untuk aktivitas sehari-hari</li><li>Memiliki upper tekstil yang dihiasi 3-Stripes</li><li>Bahan kulit imitasi pada sepatu ini memiliki aksen tampilan distress dan worn-in</li></ul><p>PESAN SEKARANG JUGA (Tulis dalam&nbsp;alamat: warna, dan ukuran)&nbsp;</p>', 'pria', 12, 0),
...
(25, 18, 'Adidas Originals POD-S3.1 Sepatu Olahraga Pria [EE7212]', 2800000, 149, 'image011.jpg', '<p>Fitur Produk</p><ul><li>Sepatu olahraga pria</li><li>Desain trendy</li><li>Neat stiching, eyelate dan outsole yang nyaman saat digunakan</li></ul><p>Material : Suede upper</p>', 'pria', 33, 0),
...
(27, 18, 'Adidas Original EQT Gazelle sepatu Olahrag Wanita[EE5153]', 1500000, 234, 'image017.jpg', '<p>Fitur Produk</p><ul><li>Sepatu olahraga wanita</li><li>Desain trendy</li><li>Neat stiching, eyelate dan outsole yang nyaman saat digunakan</li><li>Material : Synthetic outsole</li></ul>', 'wanita', 22, 0),
...
(26, 'martha', '10c4b89638b8f2cbb543c5e2401c5dff58eab917', 'martha', 'supersekali@gamail.com', 123456, 'sumatera utara', 'medan', 'medan kota', 'asDFGH', 1234, 3);
...
--
ALTER TABLE `komentar`
  MODIFY `id_komentar` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
